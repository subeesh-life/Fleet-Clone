    ...
    <q-card flat bordered class="q-pa-xs q-mb-md full-width">
      <q-card-section class="q-pa-none">
        <div class="row flex flex-center justify-between q-pa-sm bg-primary">
          <div class="col-6 text-h6 q-px-sm text-white">HS-76578
          ...
          <div class="col-6 text-body2 ">
            <FleetChips text="Upcoming - 11 M" color="purple" :iconVisibility="false" class="q-pa-xs" />
          </div>
        </div>
      ...
      <q-card-section class="q-pa-none">
        <div class="row q-mt-sm q-px-sm flex flex-center">
          ...
          <div class="col-4">
            ...
            <div class="text-body2 text-weight-medium text-grey-9">BVJ20IB1
              <q-btn flat dense padding="xs" class="q-ml-xs">
          ...
          <div class="col-12">
            <div class="column">
              <div class="row items-center q-mb-sm">
                ...
                <span class="q-ml-xs text-grey-9 ellipsis" style="max-width: 364px;">Yas Island Zone B - C67-04 - Abu
                  Dhabi, UAE
                </span>
              ...
              <div class="row items-center q-mt-sm">
                ...
                <span class="q-ml-xs text-grey-9 ellipsis" style="max-width: 264px;">Al Bateen Academy
                </span>
