        ...
        <div class="row items-start justify-between">
          <div>
            ...
            <div class="text-caption text-grey-7">
              Select the vehicle you wish to add to this event.
            </div>
          </div>
            ...
            <q-card-section>
              ...
              >
                  ...
                  <div class="row items-center full-width">
                    <div class="col-12">
                      <q-input
                        ...
                        dense
                        outlined
                        placeholder="Search by category, type, or vehicle details"
                        class="full-width"
                      >
                ...
                <template v-slot:body-cell-vehiclePlate="props">
                  <q-td>
                    <VehiclePlate
                      :plateColor="props.row.vehiclePlate.plateColor"
                ...
                <template v-slot:body-cell-vehicleDetails="props">
                  <q-td>
                    ...
                    <div class="text-caption text-weight-medium q-pl-sm">
                      {{ props.row.vehicleDetails.make }},
                      {{ props.row.vehicleDetails.model }}
                    </div>
                  </q-td>
                </template>
                ...
                <template v-slot:body-cell-workingStatus="props">
                  <q-td>
                    <div
                      ...
                      :class="{
                        'text-positive':
                          props.row.workingStatus.status === 'Available',
                        'text-negative':
                          props.row.workingStatus.status ===
                          'Under Maintenance',
                        'text-warning':
                          props.row.workingStatus.status === 'On Event',
                      }"
                    >
                      {{ props.row.workingStatus.status }}
                    </div>
                    <div
                      class="row text-caption text-weight-medium q-pl-sm text-grey-7"
                    >
