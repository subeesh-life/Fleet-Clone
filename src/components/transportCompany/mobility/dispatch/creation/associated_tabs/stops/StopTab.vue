      ...
      <q-card-section class="stats-section q-py-sm rounded-borders">
        <div class="row flex items-center justify-center">
          <div class="col-4 flex items-center q-gutter-x-sm q-px-md stats-card">
            <iconify-icon icon="hugeicons:stop" width="20px" height="20px" class="text-white" />
            <div class="text-subtitle2 text-white">0 Stops</div>
          </div>
          <div class="col-4 flex items-center q-gutter-x-sm q-px-md stats-card">
            <iconify-icon icon="hugeicons:clock-05" width="20px" height="20px" class="text-white" />
            <div class="text-subtitle2 text-white">0 Min</div>
          </div>
          <div class="col-4 flex items-center q-gutter-x-sm q-px-md stats-card">
            <iconify-icon icon="hugeicons:route-03" width="20px" height="20px" class="text-white" />
...
.stats-section::before {
  ...
  bottom: 0;
  background:
    linear-gradient(45deg, rgba(255, 255, 255, 0.05) 25%, transparent 25%) -10px 0,
    linear-gradient(-45deg, rgba(255, 255, 255, 0.05) 25%, transparent 25%) -10px 0,
