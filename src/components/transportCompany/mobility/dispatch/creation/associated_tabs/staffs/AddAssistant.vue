                ...
                <template v-slot:body-cell-select="props">
                  <q-td>
                    <q-radio
                      ...
                      :val="props.row.assistantDetails.id"
                      dense
                      class="no-outline"
                    />
                  </q-td>
                      ...
                      <div class="column">
                        ...
                        <div class="row items-center q-pl-sm">
                          ...
                          >
                            ...
                            />
                            <q-tooltip>{{
                              props.row.assistantDetails.phone
                            }}</q-tooltip>
                          </q-chip>
                          <q-chip
                            dense
                          ...
                          >
                            ...
                            />
                            <q-tooltip>{{
                              props.row.assistantDetails.email
                            }}</q-tooltip>
                          </q-chip>
                        </div>
                      </div>
