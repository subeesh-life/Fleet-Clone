        ...
        <div class="row items-center">
          ...
          <div class="col flex justify-end">
            <div
              ...
              v-if="clientSelection === 'selectiveClients'"
      ...
      <q-card-section class="q-py-sm">
        <div class="q-pa-none">
          <div class="q-gutter-md">
            <q-radio
              ...
              val="selectiveClients"
              label="Selective Clients"
            >
              <div class="text-caption text-grey-7">
                Choose clients for all stops
              </div>
            </q-radio>
            ...
            <q-radio
              ...
              checked-icon="task_alt"
              unchecked-icon="panorama_fish_eye"
              val="nonSelectiveClients"
              label="Non-Selective Clients"
            >
              <div class="text-caption text-grey-7">
                Choose clients when adding a stop
              </div>
            </q-radio>
          </div>
        </div>
        ...
        >
          <div class="col-md-8 col-sm-12">
            ...
            <q-chip>
              <q-avatar size="24px" color="primary" text-color="white">{{
                manageClients.entity
              }}</q-avatar
              >Entity
            </q-chip>
            <q-chip>
              <q-avatar size="24px" color="primary" text-color="white">{{
                manageClients.individual
              }}</q-avatar
              >Individual
            </q-chip>
          </div>
          <div class="col-md-4 col-sm-12 flex justify-end">
            <span
              class="text-body2 text-negative cursor-pointer"
      ...
      <q-card-section class="q-pb-none">
        <div class="row items-start justify-between">
          <div>
            ...
            <div class="text-caption text-grey-7">
              Select the clients you wish to add to this event.
            </div>
          </div>
      ...
      <q-card-section class="q-pt-none">
        ...
        >
          <q-tab
            ...
            :class="{ 'bg-grey-2': activeTab !== 'existing-client' }"
          >
          ...
          <q-tab
            name="new-client"
            v-model="activeTab"
            :class="{ 'bg-grey-2': activeTab !== 'new-client' }"
          >
            <template v-slot:default>
              <IconifyIcon
                icon="hugeicons:add-circle-half-dot"
          ...
          <q-tab-panel name="existing-client" class="q-pa-none q-mt-sm">
            <div class="row q-py-sm">
              <div class="col-md-6 col-sm-12 bg-grey-1">
                <q-card-section>
                    ...
                    :rows="[
                      {
                        ...
                        type: 'With Revenue',
                        image:
                          'https://d1yjjnpx0p53s8.cloudfront.net/styles/logo-thumbnail/s3/042019/gems-education.jpg?e4GtceV6NoC8OR0WGuay25bCAtCFT2mT&itok=X-sjpl1A',
                      },
                      {
                        client: 'Aldar Education',
                        phone: '971501234567',
                        email: 'aldar@gmail.com',
                        address: 'Abu Dhabi, UAE',
                        type: 'With Revenue',
                        image:
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRG7m5a0bShdDPvaq83WyNe7yOc8pwKRGi6JA&s',
                      },
                      {
                        client: 'Taaleem',
                        phone: '971501234567',
                        email: 'taaleem@gmail.com',
                        address: 'Dubai, UAE',
                        type: 'With Revenue',
                        image:
                          'https://media.licdn.com/dms/image/v2/C560BAQFxkDDhvEBnOQ/company-logo_200_200/company-logo_200_200/0/1631354649259?e=2147483647&v=beta&t=hj8QLaKDOcoZV11YwkNh6KdXGNJZOlDGFSpwLa8Dv1g',
                      },
                      {
                        client: 'Innoventure Education',
                        phone: '971501234567',
                        email: 'innoventure@gmail.com',
                        address: 'Al Ain, UAE',
                        type: 'With Revenue',
                        image:
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwXzxA5lNSaiRRrWUorZ3fwjj3tyInVHpKkQ&s',
                      },
                      {
                        client: 'SABIS Education',
                        phone: '971501234567',
                        email: 'sabis@gmail.com',
                        address: 'Dubai, UAE',
                        type: 'With Revenue',
                        image:
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNO16M1qltXTGNDFCCtmbUPrgw2TMn86NhLQ&s',
                      },
                      {
                        client: 'Bloom Education',
                        phone: '971501234567',
                        email: 'bloom@gmail.com',
                        address: 'Fujairah, UAE',
                        type: 'With Revenue',
                        image:
                          'https://media.licdn.com/dms/image/v2/D4D0BAQGviDc2oDXAKg/company-logo_200_200/company-logo_200_200/0/1737348691103/bloomeducationllc_logo?e=2147483647&v=beta&t=8R8Y2UiYQN2A4b513ZGwya7vsLc4klPgZqgTttKOUuk',
                      },
                      {
                        client: 'Esol Education',
                        phone: '971501234567',
                        email: 'esol@gmail.com',
                        address: 'Umm Al Quwain, UAE',
                        type: 'With Revenue',
                        image:
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRApFxFWxU0zfVChCYfj8z4zhWC54fpIXkHDQ&s',
                      },
                      {
                        client: 'Athena Education ',
                        phone: '971501234567',
                        email: 'athena@gmail.com',
                        address: 'Dubai, UAE',
                        type: 'With Revenue',
                        image:
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUiOk9owYLBQFLdRuVVG9LTI9aGR5kXQ2EOw&s',
                      },
                    ]"
                    :columns="[
                      {
                  ...
                  >
                    <template v-slot:top>
                      <div
                        class="row items-center full-width q-col-gutter-x-md"
                      >
              ...
              <div class="col-md-6 col-sm-12">
                <q-card-section
                  class="flex column flex-center full-height q-col-gutter-sm"
                >
                  <q-img
                    src="src/assets/states/empty-state-loader.svg"
                ...
                <q-card flat bordered class="my-card q-mx-md q-mb-md">
                  <q-card-section class="bg-grey-1">
                    ...
                    <div class="text-body2 text-grey-7">
                      Select the profile type you wish to create.
                    </div>
                        ...
                        :options="[
                          {
                            label: 'Male',
                            value: 'male',
                            class: gender !== 'male' ? 'bg-grey-2' : '',
                          },
                          {
                            label: 'Female',
                            value: 'female',
                            class: gender !== 'female' ? 'bg-grey-2' : '',
                          },
                        ]"
                      />
                    </div>
                          ...
                          >
                            <template v-slot:prepend>
                              <q-avatar size="24px">
                                <q-img
                                  class="fit"
                                  src="https://flagicons.lipis.dev/flags/4x3/ae.svg"
                                />
                              </q-avatar>
                            </template>
                          </q-select>
