...
<template>
  <q-dialog persistent backdrop-filter="blur(2px)" v-model="modelValue" position="right" :full-height="true">
    <q-card :style="$q.screen.lt.sm ? 'width: 100vw' : 'min-width: 700px; max-width: 60vw'">
      <q-card-section :class="$q.screen.lt.sm ? 'q-pa-md q-pb-none' : 'q-pb-none'">
        <div class="row items-start justify-between" :class="$q.screen.lt.sm ? 'q-col-gutter-y-md' : ''">
          ...
          <div :class="{ 'col-6 row justify-end': $q.screen.lt.sm }" class="row items-center q-gutter-x-md">
        ...
        <div class="row items-center q-col-gutter-md">
          <div class="col-md-6 col-xs-12">
            <div>
              ...
              <q-input dense outlined v-model="startDate" mask="date" :rules="['date']" placeholder="Choose Date">
          ...
          <div class="col-md-6 col-xs-12">
            <div>
              <div class="text-subtitle2 text-grey-7">End Date</div>
              <q-input dense outlined v-model="endDate" mask="date" :rules="['date']" placeholder="Choose Date">
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy cover transition-show="scale" transition-hide="scale">
      ...
      <q-card-section class="q-py-none">
        <div class="row items-center q-pa-lg" style="
          ...
          <div class="col-6 flex items-center">
            <iconify-icon icon="hugeicons:calendar-04" width="24px" height="24px" class="text-grey-7 q-mr-xs gt-sm" />
          ...
          <div class="col-6 flex items-center justify-end">
            <iconify-icon icon="hugeicons:clock-01" width="24px" height="24px" class="text-grey-7 q-mr-xs gt-sm" />
            <div class="text-grey-9 text-subtitle2">
              Estimated Trip Duration: <span class="text-grey-9 text-weight-bold">0h 0min</span>
            </div>
          </div>
        </div>
      </q-card-section>
      ...
      <q-card-section class="q-pa-md q-pt-sm">
        <div class="row items-center">
          ...
          <div class="col-6 flex items-center justify-end q-gutter-x-sm">
            <q-btn outline dense padding="xs" class="q-ml-xs" @click="gracePeriod--" :disabled="gracePeriod === 0">
              <q-tooltip>Decrease</q-tooltip>
              <iconify-icon icon="hugeicons:minus-sign" width="20px" height="20px" class="text-primary" />
            </q-btn>
            ...
            <q-btn outline dense padding="xs" class="q-ml-xs" @click="gracePeriod++">
              ...
              <iconify-icon icon="hugeicons:add-01" width="20px" height="20px" class="text-primary" />
            </q-btn>
          </div>
        </div>
      </q-card-section>
