      ...
      <q-card-section class="q-py-none">
        ...
        >
          ...
          <div class="col-6 flex items-center justify-end">
            ...
            />
            <div class="text-grey-9 text-subtitle2">
              Average Duration: <span class="text-grey-9 text-weight-bold">0h 0min</span>
            </div>
          </div>
        </div>
      </q-card-section>
      ...
      <q-card-section class="q-pa-md q-pt-sm">
        <div class="row items-center">
          ...
          <div class="col-6 flex items-center justify-end q-gutter-x-sm">
            <q-btn outline dense padding="xs" class="q-ml-xs">
            ...
            <div class="text-subtitle2 text-grey-9">10 min</div>
            <q-btn outline dense padding="xs" class="q-ml-xs">
