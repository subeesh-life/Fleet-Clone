...
const updateTimeFromQTime = (time: string | null | undefined, isStart: boolean) => {
  if (!time) return
...
<template>
  ...
  >
    <div class="text-caption q-pr-md cursor-pointer" @click="showStartTime = true">
      {{ startTime }}
    </div>
    ...
    <div class="text-caption q-pl-md cursor-pointer" @click="showEndTime = true">
      {{ endTime }}
    </div>
